...
const DriversDrivingHistory = (props) => {
  ...
  const fetchDrivingHistory = async () => {
    ...
    const response = await fetch(
      "http://localhost:8080/api/drivings/driversDrivingHistory",
      {
        method: "POST",
        headers: {
  ...
  const drivingSelectClickHandler = (driving) => {
    ...
    navigate("/driversDrivingDetailedView");
  };
...
export default DriversDrivingHistory;